...
from compression.experiments.compute_compression_stats import evaluate_zfp, evaluate_tthresh, evaluate_sz3
...
def export_compressor_stats(singleton, ensemble, compressor_name, norm_name):
    out_directory = '/home/hoehlein/PycharmProjects/results/fvsrn/classical_compressors/multivar_uvw'
