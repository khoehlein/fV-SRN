...
EXPERIMENT_NAME = f'multi-variate/single-member/parameter_interplay_qv_qhydro'
...
PARAMETERS = {
    ...
    '--data-storage:variables': ['qv', 'qhydro', 'qv:qhydro'],
...
if __name__ == '__main__':
    ...
    script_path = os.path.join(project_base_path, 'volnet/experiments/multivariate/run_training.py')
