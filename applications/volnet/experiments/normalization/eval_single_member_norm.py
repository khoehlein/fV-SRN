...
parser.add_argument_group('--norm', type=str, required=True)
parser.add_argument_group('--variable', type=str, required=True)

args = vars(parser.parse_args())

EXPERIMENT_NAME = 'normalization/single_member/{}/{}'.format(args['variable'], args['norm'])
DATA_FILENAME_PATTERN = ['../{}-min-max_scaling/{}/member{:04d}/t04.cvol'.format(args['norm'], args['variable'], l) for l in range(1, 5)]
...
PARAMETERS = {
    ...
    '--network:latent-features:volume:grid:resolution': ['6:88:63', '6:44:31'],
