...
EXPERIMENT_NAME = 'rescaled_ensemble/multi_member_multi_grid_size_comparison/16m/4g'
...
PARAMETERS = {
    ...
    '--network:latent-features:ensemble:multi-grid:resolution': grid_sizes,
    '--network:latent-features:ensemble:multi-grid:num-grids': 4,
    ...
    '--data-storage:ensemble:index-range': '1:17',
