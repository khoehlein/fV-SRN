...
EXPERIMENT_NAME = 'rescaled_ensemble/single_member_single_step_level'
DATA_FILENAME_PATTERN = ['../level_scaling/tk/member{:04d}/t04.cvol'.format(i) for i in range(1, 5)]
