...
EXPERIMENT_NAME = 'rescaled_ensemble/multi_member_multi_core_ensemble_size'
...
PARAMETERS = {
    ...
    '--network:latent-features:ensemble:num-channels': 0,
    ...
    '--network:latent-features:volume:multi-grid:num-grids': [4, 8],
