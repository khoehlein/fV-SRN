...
EXPERIMENT_NAME = 'paper/ensemble/multi_core/retraining/' + folder
...
SCRIPT_PATH = 'volnet/experiments/new_member_retraining/multi_core/run_training.py'

models_folder = '/home/hoehlein/PycharmProjects/results/fvsrn/paper/ensemble/multi_core/num_channels/' + folder + '/results/model'
