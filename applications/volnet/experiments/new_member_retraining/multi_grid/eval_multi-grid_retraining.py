...
EXPERIMENT_NAME = 'paper/ensemble/multi_grid/retraining/' + folder
...
SCRIPT_PATH = 'volnet/experiments/new_member_retraining/multi_grid/run_training.py'

models_folder = '/home/hoehlein/PycharmProjects/results/fvsrn/paper/ensemble/multi_grid/num_channels/' + folder + '/results/model'
