...
EXPERIMENT_NAME = 'rescaled_ensemble/overfitting/leaky_relu'
...
PARAMETERS = {
    ...
    '--lossmode': 'density',
    '--network:core:layer-sizes': '64:64',
    ...
    '--network:latent-features:volume:num-channels': 12,
    '--network:latent-features:volume:grid:resolution': '2:64:64',# get_grid_sizes([1, 2, 4, 8, 16], [1, 2, 4, 8]),
