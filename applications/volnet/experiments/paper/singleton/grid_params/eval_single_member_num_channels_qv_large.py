...
EXPERIMENT_NAME = 'paper/single_member/grid_params/qv/num_channels'

DATA_FILENAME_PATTERN = []
for normalization in ['level', 'local', 'global']:
    DATA_FILENAME_PATTERN += ['../{}-min-max_scaling/qv/member{:04d}/t04.cvol'.format(normalization, l) for l in range(1, 9)]
...
PARAMETERS = {
    ...
    '--network:latent-features:volume:num-channels': [24, 32, 48, 64],
