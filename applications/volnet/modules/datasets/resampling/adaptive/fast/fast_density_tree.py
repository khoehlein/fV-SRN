...
from volnet.modules.datasets.resampling.adaptive.fast.fast_data_summaries import SampleSummary, MergerSummary
...
def _test_ks_test():
    from volnet.modules.datasets.resampling.adaptive.legacy.statistical_tests import MyKolmogorovSmirnovTestNd
